	...
	const fetchReports = async () => {
		try {
			const [
				...
				axios.get(
					"https://pos-iu1y.onrender.com/reports/sales?filter=${filter"
				),
				axios.get(
					"https://pos-iu1y.onrender.com/reports/sales-returns?filter=${filter"
				),
				axios.get(
					"https://pos-iu1y.onrender.com/reports/purchases?filter=${filter"
				),
				axios.get(
					"https://pos-iu1y.onrender.com/reports/purchase-returns?filter=${filter"
				),
				axios.get("https://pos-iu1y.onrender.com/reports/suppliers"),
				axios.get("https://pos-iu1y.onrender.com/reports/stock-prices"),
			]);
