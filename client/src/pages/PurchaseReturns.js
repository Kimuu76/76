...
const PurchaseReturns = () => {
	...
	const processReturn = async () => {
		try {
			...
			await axios.post("https://pos.onrender.com", returnData);
	...
	const deletePurchaseReturn = async (id) => {
		...
		try {
			await axios.delete(`https://pos.onrender.com/purchase-returns/${id}`);
	...
	const updatePurchaseReturn = async () => {
		try {
			await axios.put(
				`https://pos.onrender.com/purchase-returns/${editingReturn.id}`,
				{
